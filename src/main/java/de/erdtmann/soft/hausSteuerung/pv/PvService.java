...
//	public Wechselrichter ladeWechselrichter() {
//				
//		return Wechselrichter.builder()
//								.withName(pvModbusClient.holeModbusRegisterString(InverterStringRegister.NAME))
//								.withLeistung(pvModbusClient.holeModbusRegisterString(InverterStringRegister.NR))
//								.withArtikelNr(pvModbusClient.holeModbusRegisterString(InverterStringRegister.ARTIKEL_NR))
//								.withSerienNr(pvModbusClient.holeModbusRegisterString(InverterStringRegister.SERIEN_NR))
//								.withAnzahlACPhasen("")
//								.withAnzahlPVStrings("")
//								.build();
//	}
...
//	public boolean isPvLeistungUeberMin() throws CoreException {
//		float pvString1 = pvModbusClient.holeModbusRegisterFloat(PvFloatRegister.DC_W_1);
//		float pvString2 = pvModbusClient.holeModbusRegisterFloat(PvFloatRegister.DC_W_2);
//		int pvGesamt = (int) (pvString1 + pvString2);
//		int minPv = konfiguration.holeMinPv();
//		
//		return pvGesamt > minPv;
//	}
	
//	public boolean isPvLeistungUeberMax() throws CoreException {
//		float pvString1 = pvModbusClient.holeModbusRegisterFloat(PvFloatRegister.DC_W_1);
//		float pvString2 = pvModbusClient.holeModbusRegisterFloat(PvFloatRegister.DC_W_2);
//		int pvGesamt = (int) (pvString1 + pvString2);
//		int maxPv = konfiguration.holeMaxPv();
//		
//		return pvGesamt > maxPv;
//	}
	
//	public boolean isBattLadungUeberMin() throws CoreException {
//		float battLadung = pvModbusClient.holeModbusRegisterFloat(BatterieFloatRegister.BATT_STAND);
//		int minBatt = konfiguration.holeMinBatt();
//		
//		return battLadung >  minBatt;
//	}

//	public boolean isBattLadungUeberMax() throws CoreException {
//		float battLadung = pvModbusClient.holeModbusRegisterFloat(BatterieFloatRegister.BATT_STAND);
//		int maxBatt = konfiguration.holeMaxBatt();
//		
